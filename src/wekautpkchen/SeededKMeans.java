...
public class SeededKMeans extends Clusterer implements OptionHandler,SemiSupClusterer,ActiveLearningClusterer {
 ...
 /** Sets training instances */
  ...
  public static void main (String[] args) {
	...
	//////// Iris data
	String datafile = "../weka-latest/data/iris.arff";
...
//"/u/ml/software/weka-latest/data/iris.arff"
	...
	System.out.println("number of instances:"+data.numInstances()+"; and num of clusters:"+num_clusters);

	// cluster with seeding      
	Instances seeds = new Instances(data,3,5);
        System.out.println("number of instances:"+seeds.numInstances()+"; and num of clusters:"+seeds.numClasses());
